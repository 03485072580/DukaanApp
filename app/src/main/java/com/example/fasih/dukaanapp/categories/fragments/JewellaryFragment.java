...
public class JewellaryFragment extends Fragment implements KeepHandleRecyclerList
    ...
    private RecyclerView jewellaryContainer;
    private ProgressBar jewellaryProgress;
    ...
    public void onRequestData(ArrayList<Products> userViewProductsList) {
        ...
        firebaseMethods.updateProgress(jewellaryProgress);
        firebaseMethods.queryProducts(getString(R.string.query_JEWELLERY), userViewProductsList, adapter);
    }
        ...
        if (Url != null) {
            if (Url.equals(getString(R.string.subCategoriesListAdapter))) {
                ...
                if (subCategoriesAdapter
                    ...
                    intent.putExtra(getString(R.string.query_type_Payal), getString(R.string.query_type_Payal));
                ...
                if (subCategoriesAdapter
                        ...
                        R.drawable.jummer) {
                    Intent intent = new Intent(getActivity(), SubCategoryActivity.class);
                    intent.putExtra(getString(R.string.query_type_Jhumar), getString(R.string.query_type_Jhumar));
                    intent.putExtra(getString(R.string.jewellaryFragment), getString(R.string.jewellaryFragment));
                    startActivity(intent);
                }
                ...
                if (subCategoriesAdapter
                        .getRecyclerSelectedCategoryObject(position)
                        .getCategoryImageResource() ==
                        R.drawable.mathapati) {
                    Intent intent = new Intent(getActivity(), SubCategoryActivity.class);
                    intent.putExtra(getString(R.string.query_type_Matha_Patti), getString(R.string.query_type_Matha_Patti));
                    intent.putExtra(getString(R.string.jewellaryFragment), getString(R.string.jewellaryFragment));
                    startActivity(intent);
                }
                if (subCategoriesAdapter
                        ...
                        R.drawable.earring) {
                    Intent intent = new Intent(getActivity(), SubCategoryActivity.class);
                    intent.putExtra(getString(R.string.query_type_Kanta), getString(R.string.query_type_Kanta));
                    intent.putExtra(getString(R.string.jewellaryFragment), getString(R.string.jewellaryFragment));
                    startActivity(intent);
                }
    ...
    private void setupFragmentWidgets(View view) {
        jewellaryContainer = view.findViewById(R.id.jewellaryContainer);
        jewellaryProgress = view.findViewById(R.id.jewellaryProgress);
    }
    ...
    public void setupRecyclerView(ArrayList<Products> userViewProductsList) {
        ...
        if (userViewProductsList != null)
            if (!userViewProductsList.isEmpty()) {
                ...
                jewellaryContainer.setAdapter(adapter);
    ...
    private void setupFirebase() {
        ...
        firebaseMethods = new FirebaseMethods(getActivity(), getString(R.string.jewellaryFragment));
